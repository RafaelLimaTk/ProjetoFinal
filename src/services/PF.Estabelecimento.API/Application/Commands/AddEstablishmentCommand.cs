...
public class AddEstablishmentCommand : Command
{
    ...
    public AddEstablishmentCommand(
    ...
    {
        ValidationResult = new AddEstablishmentValidation().Validate(this);
        return ValidationResult.IsValid;
    }
}

public class AddEstablishmentValidation : AbstractValidator<AddEstablishmentCommand>
{
    public AddEstablishmentValidation()
    {
        RuleFor(e => e.Id)
            .NotEqual(Guid.Empty)
